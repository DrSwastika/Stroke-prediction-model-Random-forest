...
This RMarkdown file contains the report of the data analysis done for the project on building and deploying a stroke prediction model in R. It contains analysis such as data preprocessing, data exploration, building and deploying the prediction models. The final report was completed on `24/4/2024`.
